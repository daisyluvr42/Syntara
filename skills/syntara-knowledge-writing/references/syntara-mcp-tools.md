...
- `syntara_style_profile`: list, get, build, save, update from revision, or set default style profiles.
...
4. Use `syntara_import` only when the user wants material added durably.
5. Use `syntara_citations` at the end, after evidence and cite keys are stable.
